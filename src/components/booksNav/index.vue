  ...
  <div class="knowledge">
    ...
    <div class="main">
      <div class="knowledge-navigation" @click="navigate">
        <span style="--i:0;--x:-1 ;--y:0"><a>金融</a></span>
        <span style="--i:1;--x:1;--y:0"><a>管理</a></span>
        <span style="--i:2;--x:0;--y:-1"><a>生物</a></span>
        <span style="--i:3;--x:0;--y:1"><a>能源</a></span>
        <span style="--i:4;--x:-1;--y:1"><a>IT</a></span>
        <span style="--i:5;--x:-1;--y:-1"><a>心理学</a></span>
        <span style="--i:6;--x:1;--y:-1"><a>语言学</a></span>
        <span style="--i:7;--x:1;--y:1"><a>人文</a></span>
      </div>
